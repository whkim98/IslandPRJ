...
<div class="main">
	...
	<form action="${pageContext.request.contextPath }/cat37/update" method="post" name = "update" >
...
<table class="table table-striped table-bordered table-hover" id="dataTables-example">
		...
		<tr>
			<th width="60">연도</th>
			<td><input type="text" value="${vo.mngbrd_part }" name = "mngbrd_part" size = "53"></td>
		</tr>
...
<script type="text/javascript">
	...
	function checkUpdate() {
		if(document.update.mngbrd_title.value == ""){
			alert("제목을 입력하십시오!");
		}else if(document.update.mngbrd_part.value == ""){
			alert("연도를 입력하십시오!")
