...
<div class="main"> 
	...
	<form action="${pageContext.request.contextPath }/cat22/write" method="post" name = "write" enctype="multipart/form-data">
	
	<input type="hidden" name="mngbrd_ctgrno" value="22">
	...
	<table class="table table-striped table-bordered table-hover" id="dataTables-example">
		<tr height="20px" valign="middle">
			<th ><div valign="middle" align="center">제목</div></th>
