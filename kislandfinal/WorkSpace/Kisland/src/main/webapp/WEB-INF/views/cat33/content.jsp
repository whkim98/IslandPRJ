...
<script>
	...
	function deleteAction() {
		...
		location.href = '${pageContext.request.contextPath }/cat33/delete?no=${vo.NO}';
	}
...
<div class="main"> 
	...
	<table class="table table-striped table-bordered table-hover" id="dataTables-example">
		...
		<c:if test="${mngcheck == vo.MANAGER_NO}">
			<input class="btn" type="button" value="수정" onclick="location.href='${pageContext.request.contextPath }/cat33/updateform?no=${vo.NO}'">
			<input class="btn" type="button" value="삭제" onclick="deleteAction()">
		</c:if>
		
		

		<input class="btn" type="button" value="목록" onclick="location.href='${pageContext.request.contextPath }/cat33/list'">
	</div>
