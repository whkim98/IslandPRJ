...
<div class="main">
	...
	<form action="${pageContext.request.contextPath }/cat33/write" method="post" name = "write" enctype="multipart/form-data">
	
	<input type="hidden" name="mngbrd_ctgrno" value="33">
